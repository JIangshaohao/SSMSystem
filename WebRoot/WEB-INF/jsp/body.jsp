...
<body>
    ...
    <header class="am-topbar am-topbar-inverse admin-header">
        <div class="am-topbar-brand" style = "width:275px;height:90px">
            <a href="ssm_index.action">
                <img src="image/logo2.jfif" width="95" height="65"/>

            </a>
            <font size="4"><b>供课系统</b></font>
        </div>
				...
				<c:if test="${user.userType == 2}">
                    ...
                    <li class="tpl-left-nav-item">
                        <a href="#" class="nav-link tpl-left-nav-link-list">
	                        ...
	                        <ul class="tpl-left-nav-sub-menu" style="display: none;">
	                            <li>
	                            	<!-- <a href="root_power.action?sign=2">
	                                    <i class="am-icon-angle-right"></i>
	                                    <span>权限分配</span>
	                                    <i class="am-icon-star tpl-left-nav-content-ico am-fr am-margin-right"></i>
	                                </a> -->
